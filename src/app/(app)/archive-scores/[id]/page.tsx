...
const ArchiveScoresPage = () => {
  ...
  useEffect(() => {
    ...
    const mockDisciplines: Discipline[] = [
      { id: 1, name: 'Математичний аналіз' },
      { id: 2, name: 'Об’єктно-орієнтоване програмування' },
      { id: 3, name: 'Бази даних' },
      { id: 4, name: 'Операційні системи' },
      { id: 5, name: 'Комп’ютерні мережі' },
    ]
    setDisciplines(mockDisciplines)
    setSelectedDisciplineId(mockDisciplines[0].id)
  }, [])
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] bg-white font-sans overflow-hidden text-black">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col overflow-hidden bg-gray-50">
          {/* Disciplines Bar - between table and switches */}
          <div className="bg-white px-6 py-3 border-b border-gray-200 overflow-x-auto no-scrollbar flex gap-2 shrink-0">
...
export default ArchiveScoresPage
