    ...
    <div className="min-h-screen bg-[#f8fafc] pb-12 font-sans">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-6">
        ...
        <DisciplineHeader
          ...
          actions={
            <>
              <button className="flex items-center gap-2.5 px-8 py-3.5 bg-white text-[#1e50f0] rounded-2xl font-bold hover:bg-blue-50 transition-all shadow-xl shadow-blue-900/10 active:scale-[0.98]">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                </svg>
                Записатися
              </button>
              <button className="p-3.5 border border-white/20 rounded-2xl hover:bg-white/10 transition-all active:scale-95 group backdrop-blur-sm">
